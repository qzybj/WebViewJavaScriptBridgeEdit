package com.library.webviewplus.util;
...
public class PhotosUtils {
     ...
     *      返回文件Uri
     */
    public static Uri startSysCamera(Activity activity, String tempFilePath,int reqCode){
    ...
    public static void refreshStatusInGallery(Activity parent, String filePath) {
        ...
        parent.getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);
    }
}
